...
liste=["flower.png","car.png","cat.png","dog.png","house.png","tree.png"]
r=0
def timing(i):
    
    
def calcul_infos():
    r=when(key.pressed,do timing

def chrono():        
time.time()-tempsInitial
...
pict1 = Picture(app, image="White.png",grid=[1,3])
